            ...
            <div class="modal-body">
                <form action="{{ url('program') }}" method="post" id="form_tambah">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_tujuan" id="modal_tambah_tujuan" class="select2" required>
                                <option value="">Pilih Tujuan</option>
                                @foreach ($tujuans as $tuj)
                                    <option value="{{ $tuj->id }}">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_target" id="modal_tambah_target" class="select2">
                                <option value="">Pilih Tujuan</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_indikator" id="modal_tambah_indikator" class="select2">
                                <option value="">Pilih Tujuan</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form method="post" id="form_edit">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_tujuan" id="modal_edit_tujuan" class="select2" required>
                                <option value="">Pilih Tujuan</option>
                                @foreach ($tujuans as $tuj)
                                    <option value="{{ $tuj->id }}">
                                        [{{ $tuj->id }}] {{ $tuj->nama_tujuan }}
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_target" id="modal_edit_target" class="select2">
                                <option value="">Pilih Tujuan</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-1">
                        ...
                        <div class="col-sm-10">
                            <select name="id_indikator" id="modal_edit_indikator" class="select2">
                                <option value="">Pilih Tujuan</option>
                            </select>
                        </div>
                    </div>
