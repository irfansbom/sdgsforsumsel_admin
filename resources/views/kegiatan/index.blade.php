            ...
            <div class="main-container container-fluid">
                <div class="page-header">
                    <div>
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('target_capaian') }}">Kegiatan</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('kegiatan/delete') }}" method="post" id="form_hapus">
                        @csrf
                        @method('delete')
                        <div class="row ">
    ...
    <div class="modal fade" id="modal_tambah">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{ url('kegiatan') }}" method="post" id="form_tambah">
                        @csrf
                        <div class="row mb-1">
                            <div class="col-sm-2">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_tambah_program" class="form-label">Program</label>
                            </div>
                            <div class="col-sm-10">
                                <select name="id_program" id="modal_tambah_program" class="form-control select2"
                                    style="width: 100%">
                                    <option value="">Pilih Tujuan</option>
                                </select>
                            </div>
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_tambah_nama" class="form-label">Nama Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kegiatan" id="modal_tambah_nama">
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-sm-2">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_tambah_pelaku" class="form-label">Pelaku Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_tambah_anggaran" class="form-label">Anggaran Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form_edit">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_edit_nama" class="form-label">Nama Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kegiatan" id="modal_edit_nama">
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-sm-2">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_edit_pelaku" class="form-label">Pelaku Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm-2">
                                <label for="modal_edit_anggaran" class="form-label">Anggaran Kegiatan</label>
                            </div>
                            <div class="col-sm-10">
...
@section('script')
    <script>
        $(document).ready(function() {
            $('#modal_tambah').find("#modal_tambah_tujuan").select2({
                dropdownParent: $("#modal_tambah")
            });
            $('#modal_tambah').find("#modal_tambah_target").select2({
                dropdownParent: $("#modal_tambah")
            });
            $('#modal_tambah').find("#modal_tambah_indikator").select2({
                dropdownParent: $("#modal_tambah")
            });
            $('#modal_tambah').find("#modal_tambah_program").select2({
                dropdownParent: $("#modal_tambah")
            });
        });
        ...
        $('.btn_edit').click(function() {
            $("#form_edit").attr('action', "{{ url('kegiatan') }}" + "/" + $(this).data('id'));
            ...
            $("#modal_edit").find('#modal_edit_nama').val($(this).data("nama_kegiatan"));
        ...
        function get_list_program() {
            $('#modal_tambah_program option').remove()
            $('#modal_tambah_program').append("<option value=''>Pilih Program</option>");
            $.ajax({
                type: "get",
                url: "{{ url('get_program') }}",
                async: false,
                ...
                success: function(res) {
                    res.data.forEach(element => {
                        $('#modal_tambah_program').append("<option value=" + element.id +
                            ">" + element.nama_program + "</option>");
                    });
                },
                error: function(error) {
                    console.log(error);
        ...
        // function get_list_program_edit() {
        //     $('#modal_edit_program option').remove()
        //     $('#modal_edit_program').append("<option value=''>Pilih Indikator</option>");
        //     $.ajax({
        //         type: "get",
        //         url: "{{ url('get_indikator') }}",
        //         async: false,
